# ros2_nvidia_isaac_docker
Docker Install (Isaac Sim + ROS 2) on Ubuntu 22.04 or Ubuntu 24.04

This repository explains how to install Docker. For Ubuntu, a script is provided for automatic installation. 
